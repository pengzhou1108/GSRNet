...
class ImageReader(object):
    ...
    def __init__(self, data_dir, mask_dir, data_list, input_size, 
        ...
        self.image_list, self.label_list = read_labeled_image_list(self.data_dir, self.mask_dir, self.data_list)
